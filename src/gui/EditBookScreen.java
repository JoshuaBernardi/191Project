...
public class EditBookScreen extends JFrame
{
	 ...
	 */
	public EditBookScreen(MainScreen mainScreen) throws DatabaseException
	{
		...
		pnlMain.setLayout(new GridLayout(7, 2, 10, 10)); // TODO: add more
															// columns
	 ...
	 * @throws DatabaseException
	 */
	private void searchBook() throws DatabaseException
	{
		...
		else
		{
			...
			{
				if (FileDatabase.getDB().getSubjects()[i]
						.equals(book.getSubject()))
				{
	 ...
	 * @throws DatabaseException
	 */
	private void editBook() throws DatabaseException
	{
